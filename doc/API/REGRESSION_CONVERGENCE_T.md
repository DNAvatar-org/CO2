...
- **Fichiers** : API_BILAN/radiative/calculations.js, API_BILAN/convergence/calculations_flux.js, API_BILAN/physics/physics.js, static/debug.js, doc/API/VAPEUR_VS_NUAGES.md

## Différences critiques (5ecb155 → HEAD)

### 1. computeSearchIncrement (API_BILAN/convergence/calculations_flux.js)
...
### 2. initForConfig T initial (API_BILAN/convergence/calculations_flux.js)
...
### 3. Tolérance flux (API_BILAN/convergence/calculations_flux.js)
...
### 4. API_BILAN/radiative/calculations.js — Search phase
...
**Note** : simulateRadiativeTransfer (API_BILAN/radiative/calculations.js) a sa propre boucle Search/Dicho. API_BILAN/convergence/calculations_flux.js a computeRadiativeTransfer avec computeSearchIncrement. Les deux chemins existent (visu vs scie).
...
| Fichier | Lignes clés |
|---------|-------------|
| API_BILAN/convergence/calculations_flux.js | computeSearchIncrement, initForConfig, calculateT0, computeToleranceWm2 |
| API_BILAN/radiative/calculations.js | Boucle Search (T0_adjustment), tolerance_current |
| API_BILAN/physics/physics.js | getH2OVaporEDSScale (5ecb155) |
| API_BILAN/albedo/calculations_albedo.js | clouds modernes Archéen |
