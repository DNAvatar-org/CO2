...
- **🍰🫧❀🌈 vs 📛** : Les 🍰🫧❀🌈 sont des **capacités radiatives IR** (⟨1−e⁻τ⟩ pondérée), pas des parts EDS. La répartition EDS (CO₂ ~20 %, H₂O ~50 % en littérature Schmidt) correspond à notre **📛** (🍰📛🏭, 🍰📛💧), répartition **tau-ratio** (une passe), différente de l'attribution marginale Schmidt ; voir doc/API/VAPEUR_VS_NUAGES.md.
