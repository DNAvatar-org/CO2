...
**Source de vérité** : `API_BILAN/config/configTimeline.js`
...
| Fichier | Rôle |
|---------|------|
| `API_BILAN/config/configTimeline.js` | Source unique des paramètres |
| `doc/autorités/VALIDATION_CONFIG_GAZ.md` | Détail masses gaz vs littérature |
...
Lors de toute modification de `API_BILAN/config/configTimeline.js` :
