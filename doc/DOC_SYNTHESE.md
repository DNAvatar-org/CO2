...
| **ALGORITHME_CALCULS.md** (racine) | Décrit simulateRadiativeTransfer | Toujours valide pour vue Visuel. computeRadiativeTransfer documenté dans calculations_flux.js (en-tête). |
