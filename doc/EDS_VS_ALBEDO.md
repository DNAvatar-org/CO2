...
Le facteur `getH2OVaporEDSScale()` (physics.js) est calculé dynamiquement depuis T, P, vapor, CO2 — formule physique, pas de hack par époque. Réf. Schmidt 2010. (Anciennement : part de H₂O dans l’EDS, constante par époque.)
