...
Using only one simplified absorption band for CO2 (around 15 microns), the model outputs EDS (flux blocked) and flux balance ; diagnostic ΔF (convention affichage) is in climate.js, not used for T calculation.
