...
const nodes = [
    { id: 'soleil', logo: '🌞', x: centerX-120, y: centerY-158, radius, fillColor: 'rgba(255, 193, 7, 0)', strokeColor: 'yellow', strokeSize: 1, left: [], right: ['6.24×10⁷<br>W/m²'], top: '', bottom: '3.8×10²⁶ W', tooltip: 'Soleil', radiation: { numCircles: 8, maxRadius: 170, openingAngle: 0, color: 'yellow' }, logoScale: 1.0, logoOffsetY: 1 },
    ...
    { id: 'albedo', logo: '🏐', x: centerX+1, y: earthCenterY+2, radius: 160, fillColor: 'rgba(0, 200, 255, 0.2)', strokeColor: 'white', strokeSize: 1, left: [], right: [], top: [], bottom: [], tooltip: 'Albédo', radiation: { numCircles: 8, maxRadius: 250, openingAngle: 345, color: 'white', rotation: 295 }, zIndex: 10, logoScale: 0.1 },
    ...
    { id: 'surface', logo: '🌍', x: centerX, y: earthCenterY, radius: 100, fillColor: 'rgba(0, 200, 255, 0.3)', strokeColor: '#00eeff', strokeSize: 1, left: [], right: [], top: '', bottom: '', tooltip: 'Surface', radiation: { numCircles: 8, maxRadius: 200, openingAngle: 310, color: 'red' }, zIndex: 15, logoScale: 0.95, logoOffsetY: 5 },
    ...
    { id: 'espace2', logo: '🛰', x: centerX+100, y: centerY+280, radius, fillColor: 'rgba(255, 255, 255, 0)', strokeColor: '', left: [], right: [], top: 'Observation', bottom: '', tooltip: 'Espace', radiation: null },

    { id: 'reemis', logo: '📛', zIndex: 25, x: centerX - 70, y: earthCenterY+150, radius: 10, logoScale: 1.0, fillColor: 'rgba(255, 0, 0, 0)', strokeColor: 'red', strokeSize: 1, left: ['Forçage<br>Radiatif'], right: ['0.00<br>W/m²'], top: '', bottom: '', tooltip: 'Réémis', radiation: { numCircles: 8, maxRadius: 75, openingAngle: 310, color: 'red' } }
];
