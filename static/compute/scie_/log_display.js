// File: static/compute/scie_/log_display.js - Helper affichage / logs (scie)
// Desc: Formatage objet → chaîne pour logs (nombres en scientifique ou 2 décimales). Vue scientifique (iframe scie_compute).
// Version 1.0.0
