...
- `scripts/generate_font.sfd` : Script FontForge pour créer la police
- `CO2CustomIcons.css` : CSS avec les classes pour utiliser la police
...
```bash
fontforge -script scripts/generate_font.sfd
```
