...
def extract_emojis_from_codebase():
    ...
    logos_file = Path(__file__).parent.parent / 'doc' / 'logos.txt'
    ...
    geology_file = Path(__file__).parent.parent / 'static' / 'geology.js'
    ...
    config_file = Path(__file__).parent.parent / 'organigramme' / 'configOrganigramme.js'
...
def main():
    ...
    generate_fontforge_script(mapping, 'generate_font.sfd')
    generate_css_fallback(mapping, 'CO2CustomIcons.css')
    
    print("\n✅ Terminé!")
    print("\n📋 Prochaines étapes:")
    print("  1. Installer FontForge: brew install --cask fontforge (macOS)")
    print("  2. Exécuter le script automatique: ./build_font.sh")
    print("     OU manuellement: fontforge -script generate_font_auto.sfd")
    print("  3. La police CO2CustomIcons.ttf sera générée dans ce répertoire")
