...
# Charger le mapping
mapping_file = Path(__file__).parent / 'CO2CustomIcons_mapping.json'
...
output_file = Path(__file__).parent / 'CO2CustomIcons.ttf'
font.generate(str(output_file))
print(f"\n✅ Police générée: {output_file}")

# Sauvegarder aussi le fichier SFD
sfd_file = Path(__file__).parent / 'CO2CustomIcons.sfd'
